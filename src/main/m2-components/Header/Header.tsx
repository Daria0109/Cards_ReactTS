...
export const Header = () => {
  return <>
    ...
    <NavLink to={PATH.UPDATE} className={s.link} activeClassName={s.active}>Refresh password</NavLink>
    <NavLink to={PATH.ENTER} className={s.link} activeClassName={s.active}>Set password</NavLink>
  </>
}